...
<figure class="order-card{{#selected}} order-card--selected{{/selected}}{{#isLast}} order-card--last{{/isLast}}{{#isFirst}} order-card--first{{/isFirst}}{{#isTrueFirst}} order-card--true-first{{/isTrueFirst}}" data-provider-id="{{id}}" data-context="provider card" data-position="{{position}}">
  <figcaption class="order-card__inner">
    <div {{#is_mobile}}class="order-card__toggle" {{^selected}}data-track data-label="open card"{{/selected}}{{/is_mobile}}>
      <img class="order-card__logo" src="http://www.sho.com/assets/images/order/tray/provider-logos/playstation-vue.png">
    </div>

    <span class="order-card__free-trial-callout">30-Day Free Trial&#42;</span>

    <h4 class="order-card__headline">Subscribe to SHOWTIME directly through PlayStation&#8482;Vue</h4>

    <div class="order-card__body">
      <div class="order-card__description">
        Download the PlayStation&#8482;Vue app from the PlayStation&reg;Store on your PS4&#8482; or PS3&#8482; console or on the web. Add SHOWTIME to your Vue channel line-up or as a standalone channel.
      </div>


      <div class="order-card__big-button-container">
        <a class="order-card__big-button button--solid-red" href="https://www.playstation.com/en-us/network/vue/showtime/#1" data-track data-label="provider lead">Go to Playstation&#8482;Vue</a>
      </div>
    </div>
    ...
    <span class="order-card__sticky-price">$8.99 per month for PlayStation&reg;Plus members</span>
    <div class="order-card__details {{#expanded}}order-card__details--expanded{{/expanded}}">
      ...
      <div class="order-card__price-description">
        <div class="order-card__price-callout-container order-card__price-callout-container--multiple">
          ...
          <span class="order-card__price-callout">
            ...
            <b>for PlayStation&reg;Plus members</b>
          </span>
        </div>  
      ...
      <div class="order-card__blurb order-card__blurb--devices">
        ...
        <h5>Once you sign up, you can stream SHOWTIME through PlayStation&#8482;Vue on your PS4&#8482; or PS3&#8482; or through the PlayStation&#8482;Vue app on Android TV, AppleTV, Fire TV, Roku, iOS and Android Tablets, or on iOS and Android phones. You can also log in through the Showtime Anytime app or on your computer at ShowtimeAnytime.com.
      </div>
      <span class="order-card__divider"></span>
