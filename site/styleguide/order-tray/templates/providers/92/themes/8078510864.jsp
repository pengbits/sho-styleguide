  ...
  <figcaption class="order-card__inner">
    ...
    <div class="order-card__body">
      <div class="order-card__description">
        Go to the Apple App Store on your Apple TV&reg;, iPad&reg;, iPhone&reg; or iPod Touch&reg;. Download the SHOWTIME app to your Apple device. Open the app to sign-up and START YOUR FREE TRIAL instantly. No cable needed.
      </div>
