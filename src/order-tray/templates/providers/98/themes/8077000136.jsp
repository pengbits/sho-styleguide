...
{{!name:Amazon Fire}}
  ...
  <figcaption class="order-card__inner">
    <div {{#is_mobile}}class="order-card__toggle" {{^selected}}data-track data-label="open card"{{/selected}}{{/is_mobile}}>
      <img class="order-card__logo" src="http://www.sho.com/assets/images/order/tray/provider-logos/amazon-fire.png">
    </div>

    <span class="order-card__free-trial-callout">7-Day Free Trial&#42;</span>

    <h4 class="order-card__headline">Download the SHOWTIME app on your Amazon Fire devices</h4>

    <div class="order-card__body">
      <div class="order-card__description">
        Go to the Amazon App Store. Download the SHOWTIME app to your Amazon Fire TV or Fire Tablet. Open the app to sign-up and START YOUR FREE TRIAL instantly. Cancel any time.
      </div>
      ...
      <div class="order-card__big-button-container">
        <a class="order-card__big-button button--solid-red" href="https://control.kochava.com/v1/cpi/click?i_cid=int-default-1888&campaign_id=koshowtime-amazon-prod55ca2912d7a464b0ff16f7321e&network_id=2708&device_id=device_id&site_id=1" data-track data-label="provider lead">Download the Showtime App</a>
      </div>
    </div>
    ...
    <div class="order-card__details {{#expanded}}order-card__details--expanded{{/expanded}}">
      ...
      <div class="order-card__blurb order-card__blurb--devices">
        ...
        <h5>Choose how you want to watch! Once you sign-up through the SHOWTIME app on your Amazon Fire TV or Fire Tablet you can download the app on other connected TVs, tablets and mobile devices &#8211; or go to Showtime.com on your computer &#8211; and stream SHOWTIME at NO ADDITIONAL COST.</h5>
