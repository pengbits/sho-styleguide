  ...
  <figcaption class="order-card__inner">
    ...
    <div class="order-card__body">
      <div class="order-card__description">
        Go to the Google Play Store on your Android TV&#8482;, Android phone or tablet. Download the SHOWTIME app to your Android device. Open the app to sign-up and START YOUR FREE TRIAL instantly. No cable needed.
      </div>
