  ...
  <figcaption class="order-card__inner">
    ...
    <div class="order-card__body">
      <div class="order-card__description">
        Amazon Prime is needed to get SHOWTIME. Go to the Amazon Video app on your favorite device and add SHOWTIME with Amazon Channels. Find it under the Channels category. You can also sign up on the Amazon website.
      </div>
    ...
    <span class="order-card__sticky-price">$8.99 per month add on with Prime membership</span>
