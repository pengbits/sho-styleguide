...
<figure class="order-card{{#selected}} order-card--selected{{/selected}}{{#isLast}} order-card--last{{/isLast}}{{#isFirst}} order-card--first{{/isFirst}}{{#isTrueFirst}} order-card--true-first{{/isTrueFirst}}" data-provider-id="{{id}}" data-context="provider card" data-position="{{position}}">
  <figcaption class="order-card__inner">
    <div {{#is_mobile}}class="order-card__toggle" {{^selected}}data-track data-label="open card"{{/selected}}{{/is_mobile}}>
      <img class="order-card__logo" src="http://www.sho.com/assets/images/order/tray/provider-logos/hulu.png">
    </div>
    <span class="order-card__free-trial-callout">30-Day SHOWTIME Free Trial for Hulu Subscribers&#42;</span>

    <h4 class="order-card__headline">Add SHOWTIME to your Hulu subscription</h4>

    <div class="order-card__body">
      <div class="order-card__description">
        Get SHOWTIME as a Premium Add-on with your Hulu subscription. New Hulu subscribers can add SHOWTIME when you sign-up online or through the Hulu app on select devices. Current Hulu subscribers can add SHOWTIME through your account settings by selecting "Manage Premium Add-ons" on select devices. Click <a href="https://help.hulu.com/articles/53536334#lrmanage">here</a> to learn how to add SHOWTIME to your Hulu subscription. No cable needed.
      </div>

      <div class="order-card__big-button-container">
        <a class="order-card__big-button button--solid-red" href="http://hulu.com/start/showtime?cmp=8062&utm_campaign=Evergreen+Leads+Tracking&utm_source=SHO.com&utm_medium=AFF" data-track data-label="provider lead">Go to Hulu</a>
      </div>
    </div>
    ...
    <div class="order-card__details {{#expanded}}order-card__details--expanded{{/expanded}}">
      ...
      <div class="order-card__blurb order-card__blurb--devices">
        ...
        <h5>Once you sign up, you can stream SHOWTIME through Hulu on your TV, tablet, phone and computer.</h5>
      </div>
      <span class="order-card__divider"></span>
