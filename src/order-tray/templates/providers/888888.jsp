  ...
  <figcaption class="order-card__inner">
    ...
    <div class="order-card__body">
      ...
      <div class="order-card__description">
        Go to the Samsung App Store on your supported Samsung Smart TV. Download and open the SHOWTIME app, then follow the on-screen instructions to sign up and START YOUR FREE TRIAL.
        <br />&nbsp;
      </div>
    </div>
